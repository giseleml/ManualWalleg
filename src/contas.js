    ...
    <div className="main-content">
      ...
      <h2>1. Contas à Receber: Recebimentos</h2>
          ...
          <ul>
            ...
            <li> Gerar nfs-e (Nota Fical Eletrônica de Serviços) na Pasta Walleg NFS-e.exe/</li>
            <li> Emitir para os mesmos clientes do mês anterior/</li>
            <li> Enviar boletos por email/</li>
          </ul>
          <p>Para acessar o Contas à Receber, selecione o ícone "Contas" na Barra de Ferramentas.</p>
      ...
      <h2>2. Gerando Boletos Mensais</h2>
        <p>Clique em Contas > Receber > Recebimentos.</p>
      ...
      <h2>3. Gerando o Número do Banco</h2>
        <p>Clique em Contas > Receber > Recebimentos</p>
        <p>Clique em Documentos > selecionar "filtrar", escolher "a vencer".</p>
        ...
        <p>Selecione todos os boletos que deseja gerar.</p>
        <p>Clicar no botão "Gerar Boleto".</p>
      ...
      <h2>4. Gerando Remessa para o Banco</h2>
            <p>Clique em Contas > Receber > Gerar Remessa</p>
            <p>Informar o Período Inicial e Final da Data de Emissão e clique no ícone de Pesquisar (lupa) ao lado.</p>
